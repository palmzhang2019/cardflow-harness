...
PROMPT_FILE=".cardflow-harness/prompts/m1-requirement-card/02-compare-candidates.md"
...
OUTPUT_FILE="${ROUND_DIR}/06-input-comparison.md"

for file in "$PROMPT_FILE" "$CODEX_FILE" "$CLAUDE_FILE" "$DEEPSEEK_FILE"; do
  if [ ! -f "$file" ]; then
